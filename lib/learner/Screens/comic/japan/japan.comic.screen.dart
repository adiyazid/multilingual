...
class JapanComicScreen extends StatefulWidget {
  const JapanComicScreen({Key? key}) : super(key: key);

  @override
  _JapanComicScreenState createState() => _JapanComicScreenState();
}

class _JapanComicScreenState extends State<JapanComicScreen> {
  int pageChanged = 0;
                                      ...
                                      children: [
                                        Container(
                                            ...
                                            decoration: const BoxDecoration(
                                                image: DecorationImage(
                                                    image: AssetImage(
                                                        'assets/comic/japan/1_japan.png'),
                                                    fit: BoxFit.fill))),
                                      ],
                                    ),
                                  ),
                                      ...
                                      Center(
                                        child: Container(
                                            ...
                                            decoration: const BoxDecoration(
                                                image: DecorationImage(
                                                    image: AssetImage(
                                                        'assets/comic/japan/2_japan.png'),
                                                    fit: BoxFit.fill))),
                                      ),
                                    ],
                                  ),
                                      ...
                                      Center(
                                        child: Container(
                                            ...
                                            decoration: const BoxDecoration(
                                                image: DecorationImage(
                                                    image: AssetImage(
                                                        'assets/comic/japan/3_japan.png'),
                                                    fit: BoxFit.fill))),
                                      ),
                                    ],
                                  ),
                                      ...
                                      Center(
                                        child: Container(
                                            ...
                                            decoration: const BoxDecoration(
                                                image: DecorationImage(
                                                    image: AssetImage(
                                                        'assets/comic/japan/4_japan.png'),
                                                    fit: BoxFit.fill))),
                                      ),
                                    ],
                                  ),
